...
class Graph:
    ...
    def get_union_edges(self) -> List[Dict]:
        ...
        for union_edge in self.union_edges:
            ...
            result.append({
                # багфикс: было union_edge.union_type, но у UnionEdge нет такого поля -- правильно meaning
                "type": union_edge.meaning,
    ...
    def add_vertex(self, concept: str, words_of_concept: Optional[List[str]] = None) -> None:
        ...
        if words_of_concept is None:
            # багфикс: было [concept.split()], что давало вложенный список [['word1', 'word2']]
            # правильно -- плоский список ['word1', 'word2']
